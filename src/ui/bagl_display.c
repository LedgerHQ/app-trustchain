...
int ui_display_add_member(bool approve) {
    if (approve) {
        add_member_confirm();
    }
    else {
...
UX_STEP_CB(ux_display_member_confirmed_step, 
           nn, 
           ui_menu_main(),
           {
               "Wallet sync", 
...
UX_FLOW(ux_display_member_confirmed_flow,
        &ux_display_member_confirmed_step);

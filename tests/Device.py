...
class SodiumDevice(device):
    ...
    def decrypt_shared_key(self, encrypted_shared_key):
        ...
        xpriv = Crypto.decrypt(ecdh, encrypted_shared_key['initializationVector'], encrypted_shared_key['encryptedXpriv'])
    ...
    def sign(self, stream:List[CommandBlock], tree=None):
        ...
        signature = sign_command_block(last_block, self.get_public_key(), self.key_pair['privateKey']).signature
